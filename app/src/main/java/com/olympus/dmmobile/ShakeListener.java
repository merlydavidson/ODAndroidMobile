...
/**
 * This is a helper class to detect when device shakes by listening to sensors.
 * 
 * @version 1.0.1
 *
 */
public class ShakeListener implements SensorEventListener {
	private static final int FORCE_THRESHOLD = 300; // 300
	...
	public void resume() {
		...
		try {
			...
			// Toast.makeText(mContext, "Shaking not supported",
